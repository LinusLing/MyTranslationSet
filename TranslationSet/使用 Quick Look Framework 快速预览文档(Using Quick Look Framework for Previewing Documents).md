...
---
原文链接：[Using Quick Look Framework for Previewing Documents](http://www.appcoda.com/quick-look-framework/)
...
你可以从[这里](https://github.com/simonng/QuickLookDemo/blob/master/QuickLookDemoStarter.zip)或者[这里](https://github.com/LinusLing/LNCodeSet/tree/master/QuickLookDemo/QuickLookDemoStarter)下载工程的初始代码。下载之后，你可以打开快速预览一下，接下去我们会一步步地引导你走下去。
...
（译者注：QLPreviewControllerDelegate 中这个方法是在预览中尝试打开某个链接时才会调用的，意思是说你要先预览某个文件，然后你点了预览文件中的某个链接，此时才会在链接跳转前调用这个方法来判断是否可以打开。）
...
你可以在 Github 上下载[完整的工程](https://github.com/appcoda/QuickLookDemo)作为参考（译者注：以上 Github 并没有完成后的整个工程，如果需要的话，可以去译者的 Github 上，也就是[这里](https://github.com/LinusLing/LNCodeSet/tree/master/QuickLookDemo/QuickLookDemoFinal)下载。）。
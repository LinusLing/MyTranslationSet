...
---
原文链接：[Local Notifications in iOS 8 with Swift (Part 1)](http://jamesonquave.com/blog/local-notifications-in-ios-8-with-swift-part-1/)
...
下半部分教程内容会在这一集的基础上添加以下功能：自定义应用图标、接收到通知后的处理和不开启应用触发通知的新特性。
